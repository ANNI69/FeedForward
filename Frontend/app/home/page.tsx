  ...
  return (
    <>
      ...
      <ImagesSlider className="h-[90vh]" images={images}>
        ...
        >
          <motion.p className="font-bold text-xl md:text-8xl text-cente bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-50 to-neutral-400 py-4 font-[Nova] sm:text-xl">
            Turning Leftovers <br />
            into Opportunities
          </motion.p>
      ...
      <div className="h-[30vh] w-full rounded-md bg-black relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-2xl mx-auto p-4">
          <h2 className="relative z-10 text-lg md:text-7xl pt-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">
            Donate From Here.
          </h2>
        </div>
        <BackgroundBeams />
      </div>
      <div className=" bg-black flex flex-wrap justify-center space-x-2 pt-20 gap-10">
        {cardsData &&
